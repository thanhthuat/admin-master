...
const SearchFillterCreateNews = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="w-full border-t-4 2xl:flex-nowrap flex-wrap text-sm border-y-3 border-y-teal-300 flex gap-7 items-center bg-white p-6" >
...
export default SearchFillterCreateNews;
